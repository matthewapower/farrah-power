...
const SubList = styled.ul`
  ...
  max-height: ${props => (props.collapsed === true) ? "0" : "400px"}};
`
      ...
      <Container>
        ...
        <Item col>
          ...
          <SubList collapsed={dropDownState}> 
            <SubLink><Link to="/hello-world">Hello World</Link></SubLink>
            <SubLink><Link to="/my-second-post">My Second Post</Link></SubLink>
            <SubLink><Link to="/new-beginnings">New Beginnings</Link></SubLink>
          </SubList>
        </Item>
