  ...
  return (
    <Layout>
      ...
      <section className="flex flex-col md:flex-row border-b border-black">
        <div className="bg-tan w-full md:w-1/3 border-black border-b md:border-b-0 p-12">
          <img
            className="block mb-0"
            src="https://res.cloudinary.com/ds9ng4srx/image/upload/v1601411479/Farrah/Film-40_uv6txz.png"
            alt="Farrah Power"
          />
        </div>
        <div className="w-full md:w-2/3 p-10 md:border-l border-black flex flex-col justify-end">
          <div className="max-w-xl">
            ...
            <p className="mb-8">
              For the past five years I have been photographing weddings and
              elopments. I have found my niche in documentary style wedding
              photography because of the way it produces meaningful and honest
              imagery that gets better over time. I live in Atlanta, GA with my
              husband Matt but continue to fall in love with the cities our
              travels bring us to.
            </p>
            <h3 className="font-heading text-lg uppercase mb-4">
            ...
            <p className="mb-4">
              ...
              <ul className="list-disc ml-5">
                ...
                <li className="mb-0">
                  To kindly approach the day focused on real moments all while
                  seeking out light & interaction
                </li>
              </ul>
            </p>
            <p className="max-w-md">
              In terms of aesthetics, my approach to your wedding day is mixing
              modern editorial taste with the honesty of the moment.
            </p>
          </div>
        </div>
      </section>
